...
try:
    ...
    # Inserir os dados em lotes na tabela 'reviews'
    for i in range(0, data_arrow.num_rows, BATCH_SIZE):
        ...
        insert_query = "INSERT INTO reviews SELECT * FROM batch_data;"
        silver_conn.execute(insert_query)
        
        print(f"Lote {i // BATCH_SIZE + 1} inserido com sucesso.")

    print("Todos os dados foram inseridos com sucesso na tabela 'reviews' do banco silver_1.")
